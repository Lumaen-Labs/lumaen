...
pub fn handler_initialize_market(
    ...
    msg!("   Liquidation Threshold: {}%", market.liquidation_threshold / 100);
    msg!("   Interest Rate: Base {}%, Optimal {}%, Slope1 {}%, Slope2 {}%",
        market.base_rate / 100,
        market.optimal_utilization / 100,
        market.slope1 / 100,
        market.slope2 / 100
    );
